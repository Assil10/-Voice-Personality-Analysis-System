...
def load_model_enhanced():
    """Load the medium model for better English transcription"""
    try:
        print("🚀 Loading Whisper medium model for enhanced English processing...")
...
def load_audio_enhanced(file_path):
    """Enhanced audio loading with better preprocessing for English"""
    try:
        # Load audio with librosa
        audio, sr = librosa.load(file_path, sr=16000, mono=True)
        
        # Enhanced normalization for English speech
...
def enhance_transcription_with_gemini(text, gemini_model):
    """Use Gemini to enhance and clean up English transcription"""
    if not gemini_model:
        return text
    
    try:
        prompt = f"""
        You are an expert in English transcription enhancement and language processing. 
        
        This text is in ENGLISH - please clean up and enhance this transcribed text. The text may contain:
        - English words/phrases with various accents (American, British, Australian, etc.)
        - Technical terms and jargon
        - Informal speech patterns and contractions
        - Transcription errors due to background noise or unclear pronunciation
        - Missing punctuation and capitalization
        - Unclear words or mumbled speech
        
        Original text: "{text}"
        
        Please provide:
        1. Cleaned and corrected text in proper English
        2. Fix transcription errors while preserving meaning
        3. Add proper punctuation, capitalization, and grammar
        4. Keep the original meaning and context intact
        5. Preserve any technical terms or proper nouns
        6. Understand context and improve readability
...
def main():
    print("🎯 Enhanced English Voice Transcription System")
    print("=" * 60)
    print("⚡ Medium model + Gemini API enhancement")
    print("🌍 Optimized for English content")
    print("🧹 Automatic cleanup and correction")
    print("=" * 60)
    
    # Setup
    input_folder = "audio_files"
    output_folder = "transcripts_english"
    ...
    print(f"\n🚀 Starting enhanced English transcription...")
    ...
    for i, file in enumerate(wav_files, 1):
        try:
            ...
            # Transcribe with enhanced settings for English
    ...
    print(f"\n🎉 Enhanced English transcription completed!")
    print(f"📊 Results:")
